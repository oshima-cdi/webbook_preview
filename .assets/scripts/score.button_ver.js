...
function Display_score() {
  ...
  flag_array.forEach( function( value ) {
    ...
    if (ContentID == "README") {
        ...
        row_title.id = "td_ContentsTitle";  // Module名以外のStyleをidで指定
    }
...
// Flag一覧の読み込みスクリプト実行
const Flag_list = document.createElement('script');
Flag_list.src = "./.assets/scripts/flag.js";
...
Q_button.id = "Display_Score";
Q_button.value = "Display Score";
Q_button.onclick = () => {
  // ボタンクリックでスコア表示処理を実行
  Display_score();
}
